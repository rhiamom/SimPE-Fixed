	...
	public class ExtProgressBar : System.Windows.Forms.UserControl
	{
		...
		{			
			...
			try 
			{
				...
				System.Drawing.Graphics gsel = System.Drawing.Graphics.FromImage(cachedimgsel);
        ...
        protected  void DrawTokens(System.Drawing.Graphics g, System.Drawing.Graphics gsel, int left, int top, int width, int height)
        {
		...
		protected virtual void DoDrawTokens(System.Drawing.Graphics g, System.Drawing.Graphics gsel, int left, int top, int width, int height)
		{
		...
		protected virtual void DrawTokenline(System.Drawing.Graphics g, System.Drawing.Graphics gsel, int left, int top, int width, int height)
		{            
			int rad = 2;
		...
		void CreateGlossyGradient(System.Drawing.Graphics g,int left, int top, int width, int height, int rad)
		{
			LinearGradientBrush b 
				= new LinearGradientBrush(
				new Rectangle(left, top, width, height), 
		...
		protected virtual void UserDrawBackground(System.Drawing.Graphics g, System.Drawing.Graphics gsel)
		{	
		...
		protected virtual void UserDrawSimple(System.Drawing.Graphics g, System.Drawing.Graphics gsel)
		{	
		...
		protected virtual void UserDrawFlat(System.Drawing.Graphics g, System.Drawing.Graphics gsel)
		{			
		...
		protected virtual void UserDrawIncrease(System.Drawing.Graphics g, System.Drawing.Graphics gsel)
		{
		...
		protected virtual void UserDrawDecrease(System.Drawing.Graphics g, System.Drawing.Graphics gsel)
		{
			double minhg = (Height-1) / 4.0;
			double step = ((Height-1) - minhg) / (this.TokenCount-1);
			for (int i=0; i<this.TokenCount; i++)
		...
		protected virtual void UserDrawBalance(System.Drawing.Graphics g, System.Drawing.Graphics gsel)
		{
			double minhg = (Height-1) / 4.0;
