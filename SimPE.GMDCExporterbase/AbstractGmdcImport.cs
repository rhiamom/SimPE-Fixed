...
namespace SimPe.Plugin.Gmdc
{
	...
	{				
        ...
        /// </summary>
        public const int FEMBODY_FACE_AMOUNT = 32000;

        /// <summary>
        /// A good Female mesh will have more than this number of Vertices
        /// </summary>
        public const int FEMBODY_VERTEX_AMOUNT = 22000;
				...
				if (this.AnimationBlocks.AuskelCorrection)
				{
					foreach (ImportedFrameBlock ifb in AnimationBlocks)	
						if (ifb.Action != AnimImporterAction.Nothing)
                            foreach (SimPe.Plugin.Anim.AnimationFrame af in ifb.FrameBlock.Frames)
                            {
