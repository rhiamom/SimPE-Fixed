...
public class WhidbeyRenderDockPanel : BaseDockPanelRenderer, IDockPanelRenderer
{
	...
	protected virtual void RenderInnerButtonBorder(Graphics g, Rectangle r, Pen pi, ButtonOrientation orient, ButtonState state, bool renderbackgroundbar)
	{
	}

	protected override void RenderButton(Graphics g, Rectangle r, Rectangle fullr, string caption, Image img, Color c, Color ci, Color fontc, Font f, StringFormat sf, ButtonOrientation orient, ButtonState state, bool renderbackgroundbar)
	{
		...
		GraphicsPath graphicsPath = ((state != ButtonState.Normal) ? ButtonIndicatorPath(r, orient) : ButtonFullPath(r));
	...
	protected virtual void FixButtonCorners(Graphics g, Brush bg, Pen p, ref Rectangle linerectangle, ref Point linept1, ref Point linept2, Pen pp)
	{
	...
	protected virtual void RenderButtonIcon(Graphics g, Image img, Rectangle imgrect)
	{
