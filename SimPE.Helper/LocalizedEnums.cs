...
namespace SimPe.Data
{
	...
	public class LocalizedNeighbourhoodEP
	{
		...
		public override string ToString()
		{
			...
			string s = Localization.Manager.GetString(key);

			// If localization succeeded:
			if (!string.IsNullOrEmpty(s))
			{
				// Special case: Mansion & Gardens (its registry/localization is inconsistent)
				if (s == "EP9")  // depending on your data value
		...
		public class LocalizedBuildSubSort
		{
			...
			/// </summary>
			/// <param name="data">The Value of the Enum</param>
			public LocalizedBuildSubSort(BuildFunctionSubSort data) //and this is just
			{
				this.data = data;
			}
