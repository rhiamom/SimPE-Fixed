...
namespace SimPe.Plugin
{
    ...
    public partial class LotexturePackedFileUI : SimPe.Windows.Forms.WrapperBaseControl, IPackedFileUI
    {
        ...
        public LotexturePackedFileWrapper TPFW
        {
            get { return (LotexturePackedFileWrapper)Wrapper; }
        }
        ...
        private void Updatey()
        {
            ...
            foreach (string clit in rtLotTex.Lines)
            {
                if (bgine)
                {
                    ...
                    i++;
                    if (i >= Wrapper.itemnum) break;
                }
                if (clit.Contains("Other Textures")) bgine = true;
            }
        }
