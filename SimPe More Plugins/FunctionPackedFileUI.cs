...
{
    public partial class FunctionPackedFileUI : SimPe.Windows.Forms.WrapperBaseControl, IPackedFileUI
    {
        ...
        {
            InitializeComponent();
            panel2.BackColor = booby.ThemeManager.Global.ThemeColorLighter;
        ...
        protected override void RefreshGUI()
        {
            ...
            if (numper > 0)
            {
                ...
                else { label3.Visible = textBox3.Visible = commnt3.Visible = false; }
                if (numper > 2)
                {
                ...
                else { label4.Visible = textBox4.Visible = commnt4.Visible = false; }
                if (numper > 3)
                {
                ...
                else { label5.Visible = textBox5.Visible = commnt5.Visible = false; }
                if (numper > 4)
                {
                ...
                else { label6.Visible = textBox6.Visible = commnt6.Visible = false; }
                if (numper > 5)
                {
                ...
                else { label7.Visible = textBox7.Visible = commnt7.Visible = false; }
                if (numper > 6)
                {
                ...
                else { label8.Visible = textBox8.Visible = commnt8.Visible = false; }
                if (numper > 7)
                {
                ...
                else { label9.Visible = textBox9.Visible = commnt9.Visible = false; }
                if (numper > 8)
                {
                ...
                else { label10.Visible = textBox10.Visible = commnt10.Visible = false; }
                if (numper > 9)
                {
                ...
                else { label11.Visible = textBox11.Visible = commnt11.Visible = false; }
                if (numper > 10)
                {
                ...
                else { label12.Visible = textBox12.Visible = commnt12.Visible = false; }
                if (numper > 11)
                {
                ...
                else { label13.Visible = textBox13.Visible = commnt13.Visible = false; }
                if (numper > 12)
                {
                ...
                else { label14.Visible = textBox14.Visible = commnt14.Visible = false; }
                if (numper > 13)
                {
                ...
                else { label15.Visible = textBox15.Visible = commnt15.Visible = false; }
                if (numper > 14)
                {
                ...
                else { label16.Visible = textBox16.Visible = commnt16.Visible = false; }
                if (numper > 15)
                {
                ...
                else { label17.Visible = textBox17.Visible = commnt17.Visible = false; }
                if (numper > 16)
                {
                ...
                else { label18.Visible = textBox18.Visible = commnt18.Visible = false; }
                if (numper > 17)
                {
                ...
                else { label19.Visible = textBox19.Visible = commnt19.Visible = false; }
                if (numper > 18)
                {
                ...
                else { label20.Visible = textBox20.Visible = commnt20.Visible = false; }
                if (numper > 19)
                {
                ...
                else { label21.Visible = textBox21.Visible = commnt21.Visible = false; }
                if (numper > 20)
                {
                ...
                else { label22.Visible = textBox22.Visible = commnt22.Visible = false; }
                if (numper > 21)
                {
                ...
                else { label23.Visible = textBox23.Visible = commnt23.Visible = false; }
                if (numper > 22)
                {
                ...
                else { label24.Visible = textBox24.Visible = commnt24.Visible = false; }
                if (numper > 23)
                {
                ...
                else { label25.Visible = textBox25.Visible = commnt25.Visible = false; }
                if (numper > 24)
                {
                ...
                else { label26.Visible = textBox26.Visible = commnt26.Visible = false; }
                if (numper > 25)
                {
                ...
                else { label27.Visible = textBox27.Visible = commnt27.Visible = false; }
                if (numper > 26)
                {
                ...
                else { label28.Visible = textBox28.Visible = commnt28.Visible = false; }
                if (numper > 27)
                {
                ...
                else { label29.Visible = textBox29.Visible = commnt29.Visible = false; }
                if (numper > 28)
                {
                ...
                else { label30.Visible = textBox30.Visible = commnt30.Visible = false; }
                if (numper > 29)
                {
                ...
                else { label31.Visible = textBox31.Visible = commnt31.Visible = false; }
                if (numper > 30)
                {
                ...
                else { label32.Visible = textBox32.Visible = commnt32.Visible = false; }
                if (numper > 31)
                {
                ...
                else { label33.Visible = textBox33.Visible = commnt33.Visible = false; }
                if (numper > 32)
                {
                ...
                else { label34.Visible = textBox34.Visible = commnt34.Visible = false; }
                if (numper > 33)
                {
                ...
                else { label35.Visible = textBox35.Visible = commnt35.Visible = false; }
                if (numper > 34)
                {
                ...
                else { label36.Visible = textBox36.Visible = commnt36.Visible = false; }
                if (numper > 35)
                {
                ...
                else { label37.Visible = textBox37.Visible = commnt37.Visible = false; }
                if (numper > 36)
                {
                ...
                else { label38.Visible = textBox38.Visible = commnt38.Visible = false; }
                if (numper > 37)
                {
                ...
                else { label39.Visible = textBox39.Visible = commnt39.Visible = false; }
                if (numper > 38)
                {
                ...
                else { label40.Visible = textBox40.Visible = commnt40.Visible = false; }
                if (numper > 39)
                {
                ...
                else { label41.Visible = textBox41.Visible = commnt41.Visible = false; }
                if (numper > 40)
                {
                ...
                else { label42.Visible = textBox42.Visible = commnt42.Visible = false; }
                if (numper > 41)
                {
                ...
                else { label43.Visible = textBox43.Visible = commnt43.Visible = false; }
                if (numper > 42)
                {
                ...
                else { label44.Visible = textBox44.Visible = commnt44.Visible = false; }
                if (numper > 43)
                {
                ...
                else { label45.Visible = textBox45.Visible = commnt45.Visible = false; }
                if (numper > 44)
                {
                ...
                else { label46.Visible = textBox46.Visible = commnt46.Visible = false; }
                if (numper > 45)
                {
                ...
                else { label47.Visible = textBox47.Visible = commnt47.Visible = false; }
                if (numper > 46)
                {
                ...
                else { label48.Visible = textBox48.Visible = commnt48.Visible = false; }
                if (numper > 47)
                {
                ...
                else { label49.Visible = textBox49.Visible = commnt49.Visible = false; }
                if (numper > 48)
                {
                ...
                else { label50.Visible = textBox50.Visible = commnt50.Visible = false; }
                if (numper > 49)
                {
                ...
                else { label51.Visible = textBox51.Visible = commnt51.Visible = false; }
                if (numper > 50)
                {
                ...
                else { label52.Visible = textBox52.Visible = commnt52.Visible = false; }
                if (numper > 51)
                {
                ...
                else { label53.Visible = textBox53.Visible = commnt53.Visible = false; }
                if (numper > 52)
                {
                ...
                else { label54.Visible = textBox54.Visible = commnt54.Visible = false; }
                if (numper > 53)
                {
                ...
                else { label55.Visible = textBox55.Visible = commnt55.Visible = false; }
                if (numper > 54)
                {
                ...
                else { label56.Visible = textBox56.Visible = commnt56.Visible = false; }
            }
