...
namespace SimPe.Plugin
{
	...
	public class IdnoForm : System.Windows.Forms.Form
	{
		...
		public IdnoForm()
		{
            ...
            if ((booby.PrettyGirls.PervyMode || booby.PrettyGirls.IsAngelsInstalled()) && Helper.StartedGui == Executable.Default)
            {
                this.pnidno.BackgroundImage = booby.PrettyGirls.NiceGirl;
            }
		}
		...
		private void InitializeComponent()
        {
            ...
            this.pnidno.BackgroundImageAnchor = booby.gradientpanel.ImageLayout.TopLeft;
            this.pnidno.BackgroundImageZoomToFit = true;
            this.pnidno.BackgroundImageLocation = new Point(650, 24);
