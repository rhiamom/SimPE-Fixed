...
namespace pjse
{
    ...
    public class GS
    {
        public enum BhavStr : uint
        {
            ...
            CatalogueUseFlags = 0xe2, // ObjectData 0x11 - Catalogue Use Flags
            //Str0x00e3 .. e4 unused
            ...
            FuncSort8Flags = 0x118, // .. Ends here - No More till 120
            ...
            BuildModeSort3Flags = 0x123, // .. Ends here - No More till 130
            ...
            PersonFlags3 = 0x207,   // PersonData 0x91 - Person Flags 3
        }
        ...
        public enum GlobalStr : uint
        {
            ...
            MaterialName = 0x0088,
            ToddlerAnims = 0x0089,
            TeenAnims = 0x008a, // no Global ones
            ElderAnims = 0x008b, // no Global ones
            CatAnims = 0x008c,
            DogAnims = 0x008d,
            LightSource = 0x008e, // no Global ones
            Effect = 0x008f,
            Bones = 0x0090, // no Global ones
            BabyAnims = 0x0091,
            ReachAnims = 0x0092,
            CareerLevels = 0x0093, // no Global ones
            SoundInfo = 0x0094, // no Global ones
            IconTexture = 0x0095,   // Balloon Icon Texture Names
            UIEffect = 0x0096, // no Global ones
            CineCam = 0x0097,
            CannotPlace = 0x0098, // See 7FA815EA and 7F12A804  // no Global ones
            PuppyAnims = 0x0099,
            KittenAnims = 0x009a,
            ...
            //no 0x00CA..0x00FF
            AttributeLabels = 0x0100, // no Global ones
            //no 0x0101
            Relationship = 0x0102, // no Global ones
            //no 0x0103..0x117
            ArrayName = 0x0118, // no Global ones
            //no 0x119..0x012c
            DialogString = 0x012d,
            MakeAction = 0x012e,
            NamedTree = 0x012f,
            LuaScript = 0x0130,
            PipMessages = 0x0131,
            DebugString = 0x0132, // no Global ones
            LuaProperty = 0x0133,
            //no 0x0134..0x018f
            ...
            BodyshapeStrings = 0x0369,
            FamilyStrings = 0x036A,
            WhatCoolDialogueStrings = 0x03E8,
            femaleStatisticStrings = 0x0F69,
            femaleProfileStrings = 0xF6A,
            maleStatisticStrings = 0x0F6B,
            maleProfileStrings = 0x0F6C,
    ...
    public abstract class BhavWiz : IDisposable
    {
        ...
        private static Hashtable flagInitaliser()
        {
            ...
            o.Add((ushort)0x91, GS.BhavStr.PersonFlags3);
            ...
            o.Add((ushort)0x11, GS.BhavStr.CatalogueUseFlags); // Catalog Use Flags
